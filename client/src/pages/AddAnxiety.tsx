...
const AddAnxiety: React.FC = () => {
    ...
    const handleAnxietySelect = async (anxiety: any) => {
        ...
        try {
            ...
            console.log(`Filtered factors for anxiety ${anxiety}:`, filteredFactors);
    ...
    const handleSubmit = async () => {
        ...
        sessionStorage.setItem('demo-anxiety', JSON.stringify({
    ...
    return (
        ...
        <div className="border-b-2 border-black mb-6"></div>
            ...
            className="font-afacad text-lg bg-black text-white">Create Custom</button>
            </div>
