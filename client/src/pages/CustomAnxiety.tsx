...
const CustomAnxiety: React.FC = () => {
    ...
    const validateForm = () => {
        ...
        if (factors.length < 3) {
            errors.push('At least 3 unique factors are required.');
        } else {
            factors.forEach((factor, index) => {
                ...
                if (factor.conditions.length === 0) {
                    errors.push(`Factor ${index + 1} must have at least 1 condition.`);
                } else {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setSelectedFactors(customFactors);
            ...
            navigate('/', { state: { customAnxietyId: newAnxietyId, selectedFactors: customFactors } }); // Navigate back to add anxiety page
    ...
    return (
        ...
        <h1 className="text-black text-center mt-5 mb-2 pt-4">Create Your Own Anxiety Source</h1>
